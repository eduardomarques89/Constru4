        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <span className="text-gray-200">Projetos sustentáveis</span>
            </div>
            <div className="flex items-center space-x-4 mt-4">
              <CheckCircle2 className="h-6 w-6 text-checked" />
              <span className="text-gray-200">Tecnologia de ponta</span>
            </div>
            <div className="flex items-center space-x-4 mt-4">
              <CheckCircle2 className="h-6 w-6 text-checked" />
              <span className="text-gray-200">Equipe especializada</span>
            </div>
          </div>
