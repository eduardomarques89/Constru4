        ...
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/constru4ei/" target='_blank' className="text-gray-200 hover:text-white transition">
                <Instagram className="h-6 w-6" />
              </a>
              <a href="https://www.linkedin.com/in/constru4-empreendimento-25162034a/" target='_blank' className="text-gray-200 hover:text-white transition">
